...
- **Fixed width layout**: Calculator maintains a consistent size regardless of input length
...
- **Input validation**: Limits input and output to eight bytes maximum
...
Quantio supports six theme variants following Material Design 3 guidelines:
...
Your theme and contrast preferences are automatically saved to localStorage and persist across sessions. The app also detects your system's color scheme preference on the first visit.
